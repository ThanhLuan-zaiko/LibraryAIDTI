...
const ArticleSidebar: React.FC<ArticleSidebarProps> = ({ article, toc, readingProgress, showCopied, onShare }) => {
    ...
    return (
        <aside className="lg:col-span-4 sticky top-40 space-y-20">
            {/* Immersive TOC Widget */}
            <div className="bg-white p-12 rounded-[3.5rem] border border-gray-100 shadow-[0_40px_80px_rgba(0,0,0,0.06)] backdrop-blur-sm">
            ...
            <div className="relative group bg-gray-950 rounded-[3.5rem] p-12 overflow-hidden shadow-4xl hover:shadow-blue-900/40 transition-all duration-700">
            ...
            <div
                ...
                className="group relative p-12 rounded-[3.5rem] bg-blue-50 border border-transparent flex flex-col items-center text-center space-y-8 shadow-xl hover:bg-white hover:border-blue-100 transition-all duration-500 cursor-pointer overflow-hidden"
            >
